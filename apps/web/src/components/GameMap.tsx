...
interface Props {
  ...
  draftQuestionPoint: [number, number] | null;
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      map.addLayer({
        ...
        paint: {
          "fill-color": ["case", ["get", "selected"], "#f06a47", "#c35dbe"],
          "fill-opacity": 0.14,
        },
      });
      map.addLayer({
      ...
      setData(
        map,
        "question-draft-point",
        draftQuestionPoint ? turf.point(draftQuestionPoint) : empty,
      );
